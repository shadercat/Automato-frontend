...
class LegacyBindMachine extends Component {
    constructor(props) {
        super(props);
        this.state = {
            validate: false,
    ...
    handleSubmit(event) {
        ...
        if (form.checkValidity() === false) {
            ...
            DataPostService.bindMachine(args)
                .then((res) => {
        ...
        return (
            <>
                ...
                <Card className="mb-3" border="dark">
                    <Card.Header>{t('bindMachine')}</Card.Header>
                    <Card.Body>
...
const BindMachineBlock = withTranslation()(LegacyBindMachine);
export default BindMachineBlock;