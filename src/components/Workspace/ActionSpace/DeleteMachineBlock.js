...
class LegacyDeleteMachine extends Component {
    constructor(props) {
        super(props);
        this.state = {
            validate: false,
    ...
    handleSubmit(event) {
        ...
        if (form.checkValidity() === false) {
            ...
            DataChangeService.deleteMachine(args)
                .then((res) => {
        ...
        return (
            <>
                ...
                <Card className="mb-3" border="danger">
                    <Card.Header>{t('deleteMachine')}</Card.Header>
                    <Card.Body>
...
const DeleteMachineBlock = withTranslation()(LegacyDeleteMachine);
export default DeleteMachineBlock;